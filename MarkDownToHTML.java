    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        while((Line)!= null){
            ...
            for(index=1; index < words.length ; index++){
                if(words[index].contains("*") || words[index].contains("#") || words[index].contains("[") || words[index].contains("!") || words[index].contains(">")){
                    break;
                }
            }
            
            if(index < words.length && (words[0].contains("*") || words[0].contains("#") || words[0].contains("[") || words[0].contains("!") || words[0].contains(">"))){
                line1 = "";
                line2 = "";
                for(i=0;i<index;i++){
                    line1 = line1 + words[i];
                ...
                check_headings(line1);
                check_text_manipulations(line1);
                check_anchors(line1);
                check_images(line1);
                check_quote(line1);
                //check_list(Prev_Line,line1);
                
                check_headings(line2);
                check_text_manipulations(line2);
                check_anchors(line2);
                check_images(line2);
                check_quote(line2);
